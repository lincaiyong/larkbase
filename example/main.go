...
func main() {
	tableUrl := "https://bytedance.larkoffice.com/base/OPd3bf8heaPa9SsB87KcRrpFnpd?table=tblatPz5AmZTrJ66&view=vewiyrjJUB"
	...
	file := "/tmp/test.json"
	//err = conn.SyncToFile(file)
	//if err != nil {
	//	log.WarnLog("%v", err)
	//	return
	//}
	records, err := conn.ReadFromFile(file)
	if err != nil {
		log.WarnLog("%v", err)
		return
	}
...
//
//	TosDemo larkbase.TextField `lark:"tos_demo"`
//	TozDemo larkbase.TextField `lark:"toz_demo"`
//}
//
